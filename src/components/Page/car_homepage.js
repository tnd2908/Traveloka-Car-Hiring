...
function CarHomePage() {
  ...
  render() {
    ...
    return (
        ...
        >
          <Panel   header={<span className="panel-header">Tại sao tôi nên thuê xe trên Traveloka?</span>} >
            <div>
          ...
          <Panel  header={<span className="panel-header">Làm thể nào để đặt xe trên Traveloka?</span>} >
            <div>
                <div><p>Bạn có thể dễ dàng đặt xe với một vài bước đơn giản:</p></div>
                  <ol>
          ...
          <Panel    header={<span className="panel-header">Tôi có thể đặt xe và được đón trong cùng ngày không?</span>}  >
            <div>
          ...
          <Panel  header={<span className="panel-header">Làm thế nào để tôi biết liệu tôi có cần đặt gói sử dụng xe ngoài thành phố?</span>}>
          </Panel>
        </Collapse>
    );
  }
    ...
    return (
        <div className="container-fluid">
          ...
          <div className="containerer">
            <div className="row">
              ...
              <img alt=".." src={process.env.PUBLIC_URL + '/images/Time.svg' }/>
              ...
              <div className="col-sm">
              <img alt=".." src={process.env.PUBLIC_URL + '/images/Quality.svg' }/>
              ...
              <div className="col-sm">
              <img alt=".." src={process.env.PUBLIC_URL + '/images/Comment.svg' }/>
        ...
        <div style={{padding:'20px 0'}} className="FAQ">
