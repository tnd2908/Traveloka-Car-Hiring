...
const CarDetail = () => {
    ...
    const fetchDetail = () => {
        try {
            axios.get(`http://108.160.134.9:3301/car/detail/${id}`)
                .then(response => {
                    ...
                    <div className="col-9">
                        <div className="car-detail container">
                            <div className="car row d-flex">
                                {/* <img className="col-xs-12 col-lg-6" alt=".." src={car.avatar} /> */}
                                <img className="col-xs-12 col-lg-6" src={ API_URL + 'images/' + car.avatar} alt=""/>
