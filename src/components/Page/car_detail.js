                ...
                <div className="car">
                    ...
                    <div className="info">
                        ...
                        <div className="iconic">
                            <p> <img alt="" src={process.env.PUBLIC_URL + '/images/pilot.png'} />Tự lái</p>
                            <p> <img alt="" src={process.env.PUBLIC_URL + '/images/wheel.png'} />Số sàn</p>
                            <p> <img alt="" src={process.env.PUBLIC_URL + '/images/minicar.png'} />Năm 2015 trở lên</p>
                        </div>
                    </div>
                </div>
